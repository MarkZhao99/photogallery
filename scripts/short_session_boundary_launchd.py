...
DEFAULT_LABEL = "com.mark.vscode1.short-session-boundary-watcher"
DEFAULT_INTERVAL_SECONDS = 1.0


def format_interval(interval_seconds: float) -> str:
    normalized = f"{float(interval_seconds):.3f}".rstrip("0").rstrip(".")
...
def launch_agent_paths(
    ...
    *,
    ...
    return {
        ...
        "watcher_script": normalized_root / "scripts" / "watch_short_session_boundary.py",
...
def build_launch_agent_plist(
    *,
    ...
    return {
        ...
        "ProgramArguments": [
            str(python_path),
            str(paths["watcher_script"].resolve()),
            "--interval",
